...
public class CutOut {
    ...
    public static final class ActivityBuilder {
        ...
        /**
         * Get {@link CutBGActivity} intent to start the activity.
         */
        private Intent getIntent(@NonNull Context context) {
            Intent intent = new Intent();
            intent.setClass(context, CutBGActivity.class);
    ...
    /**
     * Gets an Exception from the result data if the {@link CutBGActivity} failed at some point
     *
